...
<template>
    ...
    <form method="dialog" @submit="updateEvent">
        ...
        <div class="flex items-center justify-start gap-4">
            <div class="h-8 w-8 rounded mr-10" :style="eventBgStyle"></div>
            <button class="btn" @click.prevent="showColorModal">Change</button>
        </div>
    ...
    <dialog ref="colorModal" class="modal">
        <ColorModal :color="colorModalProps" @updateColor="handleChangeColor" />
    </dialog>
</template>
