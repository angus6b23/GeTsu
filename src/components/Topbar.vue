    ...
    <div class="sticky m-0 bg-base-300 min-h-[15vh] h-fit flex justify-center items-center not-for-print">
        <form class="h-full w-full">
            <div class="h-full w-full md:grid md:grid-cols-4 p-4">
                <div class="col-span-3 hidden md:grid md:grid-cols-2 xl:grid-cols-8">
                    ...
                    <div class="flex item-center justify-center col-span-2 px-8 xl:p-8 form-control">
                    ...
                    <div class="flex items-center justify-center flex-wrap md:col-span-1 xl:col-span-2">
                        <div>
